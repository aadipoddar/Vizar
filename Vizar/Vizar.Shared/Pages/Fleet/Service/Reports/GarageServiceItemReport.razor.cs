...
public partial class GarageServiceItemReport : IAsyncDisposable
{
    ...
    private List<GarageServiceItemOverviewModel> _transactionOverviews = [];

    private SfGrid<GarageServiceItemOverviewModel> _sfGrid;
    ...
    private async Task LoadTransactionOverviews()
    {
        ...
        try
        {
            ...
            _transactionOverviews = await CommonData.LoadTableDataByDate<GarageServiceItemOverviewModel>(
                ViewNames.GarageServiceItemOverview,
            ...
            if (_showSummary)
                _transactionOverviews = [.. _transactionOverviews
                    ...
                    .Select(g => new GarageServiceItemOverviewModel
                    {
                        ServiceTypeName = g.Key,
                        ServiceTypeCode = g.First().ServiceTypeCode,
                        Quantity = g.Sum(t => t.Quantity),
                        Total = g.Sum(t => t.Total)
                    })
                    .OrderBy(t => t.ServiceTypeName)];
        }
        catch (Exception ex)
        {
    ...
    private async Task ExportExcel()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await GarageServiceItemReportExcelExport.ExportReport(
    ...
    private async Task ExportPdf()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await GarageServiceItemReportPDFExport.ExportReport(
                    _transactionOverviews,
                    dateRangeStart,
                    dateRangeEnd,
                    _showAllColumns,
