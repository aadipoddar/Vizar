...
public partial class ItemPage : IAsyncDisposable
{
    ...
    private async Task ExportExcel()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await ItemExport.ExportMaster(_items, ReportExportType.Excel);
            await SaveAndViewService.SaveAndView(fileName, stream);

            await _toastNotification.ShowAsync("Success", "Item data exported to Excel successfully.", ToastType.Success);
        }
        catch (Exception ex)
        {
    ...
    private async Task ExportPdf()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await ItemExport.ExportMaster(_items, ReportExportType.PDF);
            await SaveAndViewService.SaveAndView(fileName, stream);

            await _toastNotification.ShowAsync("Success", "Item data exported to PDF successfully.", ToastType.Success);
        }
        catch (Exception ex)
        {
