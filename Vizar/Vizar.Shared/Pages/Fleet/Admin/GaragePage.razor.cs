...
public partial class GaragePage : IAsyncDisposable
{
    ...
    private async Task ExportExcel()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await GarageExcelExport.ExportMaster(_garages);
            await SaveAndViewService.SaveAndView(fileName, stream);
            await _toastNotification.ShowAsync("Exported", "Garage data exported to Excel successfully.", ToastType.Success);
        }
        catch (Exception ex)
        {
    ...
    private async Task ExportPdf()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await GaragePDFExport.ExportMaster(_garages);
            await SaveAndViewService.SaveAndView(fileName, stream);
            await _toastNotification.ShowAsync("Exported", "Garage data exported to PDF successfully.", ToastType.Success);
        }
        catch (Exception ex)
        {
