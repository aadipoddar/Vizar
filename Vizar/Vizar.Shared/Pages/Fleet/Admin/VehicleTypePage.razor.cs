...
public partial class VehicleTypePage : IAsyncDisposable
{
    ...
    private async Task ExportExcel()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await VehicleTypeExcelExport.ExportMaster(_vehicleTypes);
            await SaveAndViewService.SaveAndView(fileName, stream);
            await _toastNotification.ShowAsync("Exported", "Vehicle Type data exported to Excel successfully.", ToastType.Success);
        }
        catch (Exception ex)
        {
    ...
    private async Task ExportPdf()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await VehicleTypePDFExport.ExportMaster(_vehicleTypes);
            await SaveAndViewService.SaveAndView(fileName, stream);
            await _toastNotification.ShowAsync("Exported", "Vehicle Type data exported to PDF successfully.", ToastType.Success);
        }
        catch (Exception ex)
        {
