...
namespace Vizar.Shared.Pages.Fleet.Admin;
...
public partial class VehicleModelPage : IAsyncDisposable
{
    ...
    private async Task ExportExcel()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await VehicleModelExcelExport.ExportMaster(_vehicleModels);
            await SaveAndViewService.SaveAndView(fileName, stream);
            await _toastNotification.ShowAsync("Exported", "Vehicle Model data exported to Excel successfully.", ToastType.Success);
        }
        catch (Exception ex)
        {
    ...
    private async Task ExportPdf()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await VehicleModelPDFExport.ExportMaster(_vehicleModels);
            await SaveAndViewService.SaveAndView(fileName, stream);
            await _toastNotification.ShowAsync("Exported", "Vehicle Model data exported to PDF successfully.", ToastType.Success);
        }
        catch (Exception ex)
        {
