...
public partial class InsideRepairItemReport : IAsyncDisposable
{
    ...
    private List<InsideRepairItemOverviewModel> _transactionOverviews = [];

    private SfGrid<InsideRepairItemOverviewModel> _sfGrid;
    ...
    private async Task LoadTransactionOverviews()
    {
        ...
        try
        {
            ...
            _transactionOverviews = await CommonData.LoadTableDataByDate<InsideRepairItemOverviewModel>(
                ViewNames.InsideRepairItemOverview,
            ...
            if (_showSummary)
                _transactionOverviews = [.. _transactionOverviews
                    ...
                    .Select(g => new InsideRepairItemOverviewModel
                    {
                        ItemName = g.Key,
    ...
    private async Task ExportExcel()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await InsideRepairReportExport.ExportItemReport(
    ...
    private async Task DownloadExcelInvoice(int transactionId)
    {
        ...
        try
        {
            ...
            var (pdfStream, fileName) = await InsideRepairInvoiceExport.ExportInvoice(transactionId, InvoiceExportType.Excel);
            await SaveAndViewService.SaveAndView(fileName, pdfStream);
