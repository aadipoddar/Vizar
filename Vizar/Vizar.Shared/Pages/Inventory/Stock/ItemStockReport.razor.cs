...
public partial class ItemStockReport : IAsyncDisposable
{
    ...
    private async Task ExportPdf()
    {
        ...
        try
        {
            ...
            var (summaryStream, summaryFileName) = await ItemStockSummaryReportPDFExport.ExportReport(
                    _stockSummary,
                    dateRangeStart,
                    dateRangeEnd,
                    _showAllColumns
            ...
            {
                var (detailsStream, detailsFileName) = await ItemStockDetailsReportPDFExport.ExportReport(
                        _stockDetails,
                        dateRangeStart,
                        dateRangeEnd
                    );
    ...
    private async Task ExportExcel()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await ItemStockReportExcelExport.ExportReport(
                    _stockSummary,
                    dateRangeStart,
                    dateRangeEnd,
                    _showAllColumns,
    ...
    private async Task ConfirmDelete()
    {
        ...
        try
        {
            ...
            await ItemStockData.DeleteItemStockById(_deleteAdjustmentId);
    ...
    private async Task AutoRefreshLoop(CancellationToken cancellationToken)
    {
        try
        {
            while (await _autoRefreshTimer.WaitForNextTickAsync(cancellationToken))
                await InvokeAsync(LoadStockData);
        }
