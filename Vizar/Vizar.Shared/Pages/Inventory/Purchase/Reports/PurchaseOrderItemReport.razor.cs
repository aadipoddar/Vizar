...
public partial class PurchaseOrderItemReport : IAsyncDisposable
{
    ...
    private async Task LoadTransactionOverviews()
    {
        ...
        try
        {
            _isProcessing = true;
            StateHasChanged();
            await _toastNotification.ShowAsync("Loading", "Fetching item transactions...", ToastType.Info);

            _transactionOverviews = await CommonData.LoadTableDataByDate<PurchaseOrderItemOverviewModel>(
                ViewNames.PurchaseOrderItemOverview,
            ...
            if (_showSummary)
                _transactionOverviews = [.. _transactionOverviews
                    ...
                    .Select(g => new PurchaseOrderItemOverviewModel
                    {
                        ...
                        PurchaseQuantity = g.Sum(t => t.PurchaseQuantity)
                    })
    ...
    private async Task ExportExcel()
    {
        ...
        try
        {
            ...
            var (stream, fileName) = await PurchaseOrderReportExport.ExportItemReport(
