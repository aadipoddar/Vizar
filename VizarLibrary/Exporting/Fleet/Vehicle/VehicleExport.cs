...
public static class VehicleExport
{
        ...
        ReportExportType exportType)
    {
        ...
        var columnSettings = new Dictionary<string, ReportColumnSetting>
        {
            ...
            [nameof(VehicleModel.ChasisCode)] = new() { DisplayName = "Chasis", Alignment = CellAlignment.Left, IsRequired = true },
            [nameof(VehicleModel.EngineCode)] = new() { DisplayName = "Engine", Alignment = CellAlignment.Left, IsRequired = true },
