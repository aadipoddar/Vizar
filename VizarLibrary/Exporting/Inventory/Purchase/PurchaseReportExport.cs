...
public static class PurchaseReportExport
{
        ...
        CompanyModel company = null)
    {
        var columnSettings = new Dictionary<string, ReportColumnSetting>
        {
            ...
            [nameof(PurchaseOverviewModel.PurchaseOrderDateTime)] = new() { DisplayName = "PO Date", Format = "dd-MMM-yyyy hh:mm", Alignment = CellAlignment.Center, IncludeInTotal = false },
        ...
        else if (showAllColumns)
        {
            ...
            [
                ...
                nameof(PurchaseOverviewModel.PurchaseOrderDateTime),
